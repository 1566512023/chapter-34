  ...
  return (
    <>
      ...
      <button
        ...
        aria-expanded={open}
        className="fixed right-4 top-4 z-[70] flex h-14 w-11 items-center justify-center rounded-b-[6px] border border-[oklch(0.7_0.15_78_/_0.55)] shadow-[0_10px_30px_rgba(0,0,0,0.45)] transition-transform hover:-translate-y-0.5 sm:right-6 sm:top-0 sm:h-16 sm:w-12"
        style={{
          background:
            "linear-gradient(180deg, oklch(0.35 0.08 40) 0%, oklch(0.22 0.06 35) 60%, oklch(0.14 0.04 30) 100%)",
        }}
      >
        <span
          className="absolute inset-x-1 top-1 bottom-2 rounded-b-[4px] border border-[oklch(0.85_0.13_78_/_0.35)]"
          aria-hidden
        />
        <span
          className="relative font-display text-lg italic leading-none"
          style={{ color: "oklch(0.9 0.13 78)" }}
        >
          {open ? "×" : "❦"}
        </span>
      </button>
      ...
      <aside
        ...
        className={`fixed right-0 top-0 z-[65] flex h-[100dvh] w-[92vw] max-w-sm flex-col border-l border-[oklch(0.7_0.15_78_/_0.4)] shadow-[-20px_0_60px_rgba(0,0,0,0.55)] transition-transform duration-500 ease-[cubic-bezier(0.7,0,0.2,1)] ${
      ...
      >
        {/* Inner gold border */}
        <div
          className="pointer-events-none absolute inset-3 rounded-sm border border-[oklch(0.85_0.13_78_/_0.3)]"
          aria-hidden
        />
        ...
        <header className="relative px-8 pt-10 pb-5">
          ...
          <div className="mt-4 h-px w-16 bg-[oklch(0.85_0.13_78_/_0.6)]" />
        </header>
        ...
        <nav className="relative flex-1 overflow-y-auto px-6 pb-8">
                ...
                <li key={e.to}>
                  <Link
                    ...
                    className={`group flex items-center gap-3 rounded-sm px-3 py-2 font-display text-sm italic transition-colors ${
                      active
                        ? "bg-[oklch(0.85_0.13_78_/_0.15)] text-[oklch(0.95_0.1_82)]"
                        : "text-[oklch(0.85_0.08_82_/_0.75)] hover:text-[oklch(0.9_0.13_78)]"
                    }`}
                  >
                    <span
                      ...
                      style={{ background: "oklch(0.85 0.13 78)" }}
                      aria-hidden
                    />
          ...
          <div className="my-5 h-px bg-[oklch(0.85_0.13_78_/_0.15)]" />
                ...
                <li key={c.id}>
                  <Link
                    ...
                    className={`group relative flex items-baseline gap-3 rounded-sm py-2 pl-4 pr-3 transition-colors ${
                      active
                        ? "bg-[oklch(0.85_0.13_78_/_0.12)]"
                        : "hover:bg-[oklch(0.85_0.13_78_/_0.06)]"
                    }`}
                  >
                    {/* Bookmark ribbon */}
                    <span
                      className={`absolute left-0 top-1 h-8 w-1.5 rounded-r-sm transition-all ${
                        active
                          ? "opacity-100 shadow-[0_0_10px_oklch(0.85_0.13_78_/_0.7)]"
                    ...
                    <span
                      className={`flex-1 font-display italic ${
                        active
                          ? "text-[oklch(0.98_0.08_82)]"
                          : "text-[oklch(0.9_0.05_82_/_0.85)] group-hover:text-[oklch(0.95_0.1_82)]"
                      }`}
                    >
                      {c.title}
                    </span>
        ...
        <footer className="relative border-t border-[oklch(0.85_0.13_78_/_0.2)] px-6 py-4 text-center">
          <p
            ...
            style={{ color: "oklch(0.85 0.08 82 / 0.7)" }}
          >
