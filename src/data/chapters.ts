...
export const chapters: Chapter[] = [
  ...
  },
  {
    ...
    items: [
      { id: "s1", title: "The Beginning", subtitle: "1992", body: "The day the story began." },
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        id: "zane",
        title: "Zane",
        body: "The little heart that turned her into a mother. The love that rewrites every page.",
        details: [
          "The prayer that became a person. The reason for a thousand quiet thank-yous.",
          "In his little hands, God placed a whole new chapter of her heart.",
        ],
        keepsakes: [
          { label: "A first", note: "the day he called you 'mama'" },
          { label: "A prayer", note: "that he grow up rooted in love and truth" },
        ],
      },
      { id: "blank-1", title: "A Blossom Waiting", body: "A place kept open for a name only you can plant.", placeholder: true },
      { id: "blank-2", title: "A Blossom Waiting", body: "Another soul the years may yet bring.", placeholder: true },
      { id: "blank-3", title: "A Blossom Waiting", body: "For a friend not yet met.", placeholder: true },
      { id: "blank-4", title: "A Blossom Waiting", body: "For a mentor still ahead.", placeholder: true },
      { id: "blank-5", title: "A Blossom Waiting", body: "For someone God will use in ways only He can see.", placeholder: true },
    ],
  },
  {
    id: "foundation",
  ...
  },
  {
    ...
    items: [
      ...
      { id: "next-dream", title: "My Next Dream", subtitle: "Whispered", body: "A dream still forming. A prayer still rising.", placeholder: true },
      { id: "another-prayer", title: "Another Prayer", subtitle: "In His hands", body: "For a longing only He hears in full.", placeholder: true },
      { id: "place-to-visit", title: "A Place I'd Love to Visit", subtitle: "One day", body: "A city, a coast, a chapel — waiting to be seen.", placeholder: true },
      { id: "future-goal", title: "A Future Goal", subtitle: "Believing", body: "The next horizon He has already gone before you toward.", placeholder: true },
      { id: "blank-dream-1", title: "___________", subtitle: "Waiting", body: "A blank card for a dream not yet named.", placeholder: true },
      { id: "blank-dream-2", title: "___________", subtitle: "Waiting", body: "God is still writing. This page is yours.", placeholder: true },
    ],
  },
  {
    id: "memories",
    ...
    items: [
      { id: "2010", title: "2010", body: "The story begins to gather." },
      { id: "2011", title: "2011", body: "Small pages, quietly filling." },
      { id: "2012", title: "2012", body: "New rooms in an unfolding year." },
      { id: "2013", title: "2013", body: "Prayers kept in the margins." },
      { id: "2014", title: "2014", body: "A season of shaping." },
      { id: "2015", title: "2015", body: "Quiet growth." },
      { id: "2016", title: "2016", body: "New beginnings written in ink." },
      { id: "2017", title: "2017", body: "Deeper roots." },
      { id: "2018", title: "2018", body: "Doorways opening." },
      { id: "2019", title: "2019", body: "Steady steps." },
      { id: "2020", title: "2020", body: "A year to remember — for what it took and what it gave." },
      ...
      {
        id: "2026",
        title: "2026 — Chapter 34",
        subtitle: "This Year",
        body: "This year. This chapter. This gift.",
        details: [
          "Welcome Home, Pen — a prayer answered on four wheels.",
          "Birthday Memories · Family Moments · Journal Entries",
          "Videos · Voice Notes · Answered Prayers",
          "Business Milestones · Photo Gallery",
          "Every road travelled another chapter of God's faithfulness.",
        ],
        keepsakes: [
          { label: "Welcome Home, Pen", note: "the day the keys came home" },
          { label: "A blank page", note: "for every memory still to be made" },
        ],
      },
      { id: "2027", title: "2027", body: "A blank album, waiting.", placeholder: true },
      { id: "2028", title: "2028", body: "Another blank album, waiting.", placeholder: true },
    ],
  },
  {
    id: "love-letter",
